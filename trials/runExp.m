...
% --------------------------------------
behav_txt_head{1}       =   'onset';                        behav_mat_res{1}        =   expDes.blockMat(:,5);
behav_txt_head{2}       =   'duration';                     behav_mat_res{2}        = 	expDes.blockMat(:,6)-expDes.blockMat(:,5);
behav_txt_head{3}       =   'run_number';                   behav_mat_res{3}        = 	expDes.blockMat(:,1);
behav_txt_head{4}       =   'trial_number';                 behav_mat_res{4}        = 	expDes.blockMat(:,2);
behav_txt_head{5}       =   'image_blank_size';             behav_mat_res{5}        = 	expDes.blockMat(:,3);
behav_txt_head{6}       =   'image_blank_num';              behav_mat_res{6}        = 	expDes.blockMat(:,4);

head_line               =   [];
for trial = 1:const.trial_per_block
    % header line
    if trial == 1
