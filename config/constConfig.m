...
const.img_tot_num           =   80;                                                                 % total number of natural images
const.img_size_num          =   2;                                                                  % total number of image sizes
const.ratio_img_blk         =   1/8;                                                                % ratio of blank trial relative to the image trials
const.trials_tot_num        =   (const.img_tot_num * const.img_size_num)*(1+const.ratio_img_blk);   % total number of trials
const.block_num             =   20;                                                                 % number of blocks
